...
- **Build record (Tesla T4, seed 42 split):** frozen CER @P:FROZEN_CER@ / WER @P:FROZEN_WER@ on the 140 held-out lines (@P:FROZEN_READ@), adapted **@P:ADAPTED_CER@** / **@P:ADAPTED_WER@** (epoch @P:BEST_EPOCH@ of 8, @P:ADAPTED_EXACT@ lines exact), reload parity 8/8; the report page after adaptation: @P:DRAWING_AFTER@. One seeded split of one 800-line sample; no dispersion estimate. The sibling rows on the same split: GOT-OCR 2.0 0.759, Florence-2 0.797, SmolVLM-500M @P:SMOLVLM_CER@.
